              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-primary hover:bg-indigo-600 text-white" href="https://nucleoapp.com/pricing" target="_blank" rel="noreferrer">Buy Nucleo</a>
                ...
                <div>
                  ...
                  <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-primary hover:bg-indigo-600 text-white" href="https://tablericons.com/" target="_blank" rel="noreferrer">Download Tabler Icons</a>
                    </div>
                  </div>
                </div>
