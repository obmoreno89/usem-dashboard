                    ...
                    <div className="text-center">
                      ...
                      <ul className="inline-flex flex-wrap text-sm font-medium">
                        <li className="after:content-['/'] last:after:hidden after:text-slate-400 after:px-2">
                          <a className="text-slate-500 hover:text-primary" href="#0">Home</a>
                        </li>
                        <li className="after:content-['/'] last:after:hidden after:text-slate-400 after:px-2">
                          <a className="text-slate-500 hover:text-primary" href="#0">Settings</a>
                        </li>
                        <li className="after:content-['/'] last:after:hidden after:text-slate-400 after:px-2">
                          <a className="text-slate-500 hover:text-primary" href="#0">Notifications</a>
                        </li>
                      </ul>
                      {/* End */}
                    </div>
