...
function Notification({
  ...
  const typeIcon = (type) => {
    switch (type) {
      ...
      default:
        return (
          <svg className="w-4 h-4 shrink-0 fill-current text-primary mt-[3px] mr-3" viewBox="0 0 16 16">
        ...
        <div className={className}>
          <div className="inline-flex flex-col max-w-lg px-4 py-2 rounded-sm text-sm bg-white shadow-lg border border-slate-200 text-slate-600">
            ...
            <div className="text-right mt-1">
              <a className="font-medium text-primary hover:text-indigo-600" href="#0">Action -&gt;</a>
            </div>
          </div>
        </div>
      }
